...
import com.metadata.engine.be.metadata_engine_be.models.dto.SchemaTable;
...
public class SchemaExtractionService {
    ...
    public BulkSchemaRequest extractSchema(Long jobId, DataConnection connection) throws Exception {
        sse.sendEvent(jobId,
