...
* The original package name 'com.metadata.engine.be.metadata-engine-be' is invalid and this project uses 'com.metadata.engine.be.metadata_engine_be' instead.
